...
class Curl{
    ...
    public function getOptions($_options = array())
    {
        $options = self::mergeArray($this->request_options, $this->options, $this->_config, $_options);
        return $options;
    }
    ...
    public function get($url, $params = array(), $header = array(), $debug = false)
    {
        ...
        $tmpOptions = $this->mergeHeaders($header);
        $options = $this->getOptions($tmpOptions);
    ...
    public function put($url, $data = null, $params = array(), $header = array(), $debug = false)
    {
        $url = $this->buildUrl($url, $params);
    ...
    public function patch($url, $data = array(), $params = array(), $header = array(), $debug = false)
    {
        $url = $this->buildUrl($url, $params);
        $tmpOptions = $this->mergeHeaders($header);
        $options = $this->getOptions($tmpOptions);
    ...
    public function delete($url, $params = array(), $header = array(), $debug = false)
    {
        $url = $this->buildUrl($url, $params);
        $tmpOptions = $this->mergeHeaders($header);
        $options = $this->getOptions($tmpOptions);
    ...
    private function buildHeaders($header = array())
    {
    ...
    private function mergeHeaders($header = array()){
        $h = isset($this->request_options[CURLOPT_HTTPHEADER]) ? $this->request_options[CURLOPT_HTTPHEADER] : array();
        $h = self::mergeArray($h, $this->buildHeaders($header));
        return array(CURLOPT_HTTPHEADER => $h);
    }
