...
class ImagesController extends Controller{
    ...
    public function actions(){
        return array(
        	...
        	'edit_pdf'=>'application.controllers.images.Edit_pdfAction',
            'editpdf'=>'application.controllers.images.EditpdfAction',
			'cate'=>'application.controllers.images.ListcateAction',
        		'editcate'=>'application.controllers.images.EditcateAction',
        );
    }
}