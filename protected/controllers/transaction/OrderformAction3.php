...
class OrderformAction3 extends CAction{
    public function run()
    {
        $action = $this->getId();
    ...
    //查询是否具有开增值税发票资质
        ...
        {	
        	...
        	$order_arr = CTransaction::searchAllorder3($page,$size,$where='status=3 and');
        	$count = CTransaction::countorder($where='status=3 and');
        }
