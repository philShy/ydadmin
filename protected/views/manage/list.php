...
<div class="page-content clearfix">
    <div class="administrator">
       ...
       <span class="l_f">
        <a href="javascript:ovid()" id="administrator_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加管理员</a>
                ...
                <span class="r_f">共：<b><?php echo $count;?></b>人</span>
            </div>
            <!--管理员列表-->
            <div class="clearfix administrator_style" id="administrator">
                <div class="table_menu_list"  id="testIframe" style="margin-left:0;width:100%">
                    <table class="table table-striped table-bordered table-hover" id="sample_table">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <?php if($value['state'] == 0):?>
                                    <a onClick="member_stop(this,'<?php echo $value['id']?>')"  href="javascript:;" title="停用" class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>
                                <?php elseif($value['state'] == 1):?>
                                ...
                                <a title="编辑"  href="/manage/editmanager?id=<?php echo $value['id']?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
    ...
    <div id="add_administrator_style" class="add_menber" style="display:none">
        <form action="/manage/list" method="post" id="form-admin-add">
            ...
            <div class="form-group">
                ...
                <div class="formControls  skin-minimal">
                    ...
                    <label><input name="sex" type="radio" class="ace" value=0><span class="lbl">男</span></label>&nbsp;&nbsp;
...
<!--                <div class="col-4"> <span class="Validform_checktip"></span></div>-->
            ...
            <div class="form-group">
                ...
                <div class="formControls">
                    <textarea name="note" cols="" rows="" class="textarea" placeholder="说点什么...100个字符以内" dragonfly="true" onkeyup="checkLength(this);"></textarea>
    ...
    function member_stop(obj,id){
        ...
        layer.confirm('确认要停用吗？',function(index){
            $.ajax({
                type: "POST",
                url: url,
                data: {manager_id:manager_id,state:1},
                dataType: "json",
    ...
    function member_start(obj,id){
        ...
        layer.confirm('确认要启用吗？',function(index){
            $.ajax({
                type: "POST",
                url: url,
                data: {manager_id:manager_id,state:'sure'},
                dataType: "json",
                success: function(data){
    ...
    function member_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: "POST",
                url: url,
                data: {manager_id:manager_id,is_delete:1},
                dataType: "json",
                success: function(data){
