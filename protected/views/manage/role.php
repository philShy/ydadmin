...
<div class="page-content clearfix">
    <div class="administrator">
       ...
       <span class="l_f">
        <a href="/manage/addrole" class="btn btn-warning"><i class="fa fa-plus"></i> 添加角色</a>
       </span>
            ...
            <div class="clearfix administrator_style" id="administrator">
                ...
                <div class="table_menu_list"  id="testIframe" style="margin-left:0px;">
                        ...
                        <?php foreach($allManager as $key=>$value):?>
                            <tr>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a title="编辑" href="/manage/editrole?id=<?php echo $value['id']?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
    ...
    function member_start(obj,id){
        ...
        layer.confirm('确认要启用吗？',function(index){
            $.ajax({
                type: "POST",
                url: url,
                data: {role_id:role_id,state:'sure'},
                dataType: "json",
                success: function(data){
    ...
    function member_del(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: "POST",
                url: url,
                data: {role_id:role_id,is_delete:1},
                dataType: "json",
                success: function(data){
