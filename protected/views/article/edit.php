                   ...
                   <span class="formControls col-4"><select name="cate" class="form-control" id="form-field-select-1">
                    ...
                    <span class="formControls col-4"><select name="author" class="form-control" id="form-field-select-1">
                           <?php foreach($author_arr as $key=>$value):?>
                               <option <?php if($article_one['author']==$value['id']) echo 'selected';?> value="<?php echo $value['id']?>"><?php echo $value['name']?></option>
                           <?php endforeach;?>
                       </select>
                   </span>
                    </li>
                	...
                	<div id="odiv_goods">
	        &nbsp;&nbsp;<input class='contact_goods_str' type='text'  value='<?php echo $article_one['contact_goods']?>'name='contact_goods_str' />
 				...
 				<li id='contact_article' class="clearfix"><label class="label_name">关联文章</label>
 					<div id="odiv_article" style="display: inline-block">
	                    &nbsp;&nbsp;<input class='contact_article_str' type='text' value='<?php echo $article_one['contact_article']?>' name='contact_article_str' />
	                ...
	                <div>
	                	<select style='margin-left:98px;display:none' id='multi-article' multiple='multiple'>
						</select>
	                </div>
