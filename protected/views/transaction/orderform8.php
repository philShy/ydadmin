        ...
        <div class="centent_style" id="centent_style">
            ...
            <div class="search_style">
                ...
                <?php if($auth_arr['role'] != '仓管'):?>
                    ...
                    <a href='/transaction/orderform8'><button style="background:#2a8bcc;">未开发票订单</button></a>
                <?php endif;?>
                ...
                <?php foreach($order_arr as $key=>$value):?>
                    ...
                    <tr class='ppp'>
                        <td>
                                ...
                                <table width=100% height=100%>
                                    ...
                                    <tr style='height:0px;'>
                                        <td style='text-align:center;width:50%;border-right:1px solid #ccc' rowspan=<?php echo $count_all[$key]+1?>>
                                            <?php if($c_id['sub_status']==1 && ($auth_arr['role'] == '销售' || $auth_arr['role'] == '超级管理员')):?>
                            ...
                            <?php else:?>
                                <?php if($value['payment']==2 && $auth_arr['role'] == '财务' || $auth_arr['role'] == '超级管理员'):?>
                                    <a style='display:inline-block;margin-bottom:5px;border:1px solid #ccc' class = 'zhz' href = 'javascript:void(0);' price = '<?php echo $value['price']?>' order_id = '<?php echo $value['id']?>'>转账</a>
                                <?php endif;?>
                                <?php echo $value['id']?>
                            <?php endif;?>
                        </td>
...
<script>
    ...
    $(function(){
        ...
        $('.zhz').click(function(){
            ...
            var url = 'http://www.rdbuy.com.cn/flow/estpaySuer';
            layer.confirm('是否已收到公司转账',function (index) {
                $.ajax({
                    type: "get",
                    async: true,
                    url: url,
