    ...
    <div class="cover_style" id="cover_style">
        ...
        <div class="centent_style" id="centent_style">
            ...
            <div class="search_style">
                ...
                <a href='/transaction/orderform1'><button style="background:#2a8bcc;">未支付订单</button></a>
            ...
            <table class="table_order" width="100%">
                ...
                <tr class='ppp'>
                    <td>   
						...
						<?php $count_all+= count($c_id)-5?>
						<?php endforeach;?>
						<?php foreach($value['goods_detail'] as $sub_k=>$sub_v):?>
						
							<?php if($sub_v['is_advance_order']==1):?>
								<tr>
									<td style='text-align:center;width:50%;border-right:1px solid #ccc' rowspan=<?php echo $count_all?>>
									<?php if($sub_v['sub_status']==1):?>
									<a style='display:inline-block;margin-bottom:5px;border:1px solid #ccc' class = 'receive' href = 'javascript:void(0);' order_sub_id = '<?php echo $sub_v[0]['order_id']?>'>请接单</a>
									<?php endif;?>
									<?php echo $value['id']?>
									</td>
									<td rowspan=<?php echo count($sub_v)-5 ?> class='orderid' style="height:44px;border-bottom:1px solid #ccc;text-align: center;"><?php echo $sub_k;?></td>
								</tr>
							<?php else:?>	
								<tr>
								
									<td rowspan=<?php echo count($sub_v)-5 ?> style="text-align: center;height:44px"><?php echo $sub_k;?></td>
								</tr>
