    ...
    <div class="cover_style" id="cover_style">
        ...
        <div class="centent_style" id="centent_style">
            ...
            <div class="search_style">
                ...
                <a href='/transaction/orderform6'><button style="background:#2a8bcc;">已完成订单</button></a>
                        ...
                        <?php if($value['status']==2):?>
                            <table width=100% height=100%>
                                ...
                                <?php foreach($value['goods_detail'] as $sub_k=>$sub_v):?>
                                    <tr>
                                        <td rowspan=<?php echo count($sub_v)-5 ?> class='orderid' style="height:44px;text-align: center;"><?php echo $sub_k;?></td>
                                    </tr>
                                <?php endforeach;?>
                            </table>
                        <?php else:?>
