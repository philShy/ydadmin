...
<div class="margin clearfix">
    <div class="article_style">
        <form action="/system/edit_doc" method="post" id="add-article" enctype="multipart/form-data">
            <input value="<?php echo $doc_one['id']?>" name="id" type="hidden"/>
            <div class="add_content" id="form-article-add">
                <ul>
                    <li class="clearfix Mandatory">
                        <label class="label_name"><i>*</i>文章标题</label><span class="formControls col-10"><input value="<?php echo $doc_one['title']?>" name="title" type="text" style="width:500px" ></span>
                    </li>
                    <li class="clearfix Mandatory"><label class="label_name"><i>*</i>文章简介</label>
                        <span class="formControls col-10"><input value="<?php echo $doc_one['introduce']?>" name="introduce" type="text" style="width:500px" ></span>
                    </li>
                   ...
                   <span class="formControls col-4"><select name="cate" class="form-control" id="form-field-select-1">
                           <?php foreach($cate_arr as $key=>$value):?>
                               <option <?php if($doc_one['doc_category_id']==$value['id']){echo 'selected';}?> value="<?php echo $value['id']?>"><?php echo $value['name']?></option>
                           <?php endforeach;?>
                       </select>
                   </span>
                    </li>
                    <li class="clearfix"><label class="label_name">文章作者</label>
                        <span class="formControls col-10"><input value="<?php echo $doc_one['author']?>" name="author" type="text" id="form-field-1" style="width:91px"></span>
                    </li>
                    <li class="clearfix"><label class="label_name">点击量</label>
                        <span class="formControls col-10"><input value="<?php echo $doc_one['hit']?>" name="hit" type="number" id="form-field-1" style="width:91px"></span>
                    </li>
                    <li class="clearfix"><label class="label_name">点赞数</label>
                        <span class="formControls col-10"><input value="<?php echo $doc_one['thumb']?>" name="thumb" type="number" id="form-field-1" style="width:91px"></span>
                    </li>
                    ...
                    <span class="formControls col-4">
                        <select name="recommend" class="form-control" id="form-field-select-1" style="width:91px">
                            <option <?php if($doc_one['is_recommend']==0){echo 'selected';}?> value="0">不推荐</option>
                            <option <?php if($doc_one['is_recommend']==1){echo 'selected';}?> value="1">推荐</option>
                            <option <?php if($doc_one['is_recommend']==2){echo 'selected';}?> value="2">主推</option>
                        </select>
                    </span></li>
                    <!--<li>
                    ...
                    <li class="clearfix"><label class="label_name">文章内容</label>
                        <span class="formControls col-10"><script id="content" name="content" type="text/plain" style="width:100%;height:400px; margin-left:10px;"><?php echo $doc_one['content']?></script> </span>
                    </li>
                </ul>
