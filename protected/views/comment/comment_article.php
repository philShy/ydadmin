            ...
            <div class="search_style">
                <form action="" method="post">
                    <ul class="search_content clearfix">
                        ...
                        <li><label class="l_f">文章标题</label><input name="article" type="text"  class="text_add" placeholder="文章标题"  /></li>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <?php foreach($article_comment as $key=>$value):?>
                        <tr>
                            ...
                            <td><?php echo $value['thum_up']?></td>
                            <td>
                            <?php
                            $res = CComment::select_comment_info_all_bycommentid($value['id']);
                            echo count($res);
                            ?>
                            </td>
                            <td><?php echo $value['create_time']?></td>
                            <td style="display: none" class="text-l"></td>
                            <td class="td-status">
...
<script>
    jQuery(function($) {
        var oTable1 = $('#sample-table').dataTable( {
            ...
            "aoColumnDefs": [
                ...
                {"orderable":false,"aTargets":[2,3,4,8,9,10]}// 制定列不参与排序
            ] } );
    ...
    function member_edit(iid){
        ...
        layer.open({
        	  ...
        	  shade: 0.3,
        	  area: ['90%', '90%'],
        	  content: '/comment/comment_article_info?id='+iid,
        	});
