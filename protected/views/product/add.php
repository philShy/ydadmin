...
#attr{float:left;width:80%;display:none;margin-top:10px;}
    ...
    * { padding: 0; margin: 0; }  
    ...
    .model{border:1px solid #ddd;margin-top:5px;margin-left: 114px;float:left;}
...
<div class="clearfix" id="add_picture">
    <div class="page_right_style" style="width:100%;position:relative">
        <div class="type_title">添加商品</div>
        <form action="/product/add" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
            <input type='hidden' id="one_json" name='one_json' value="">
            <input type='hidden' id="json" name='json' value="">
            <input type='hidden' style="width:1400px;" id="model_sku" name='model_sku_json' value="">
            <input type='hidden' id="model_attr" name='model_attr_json' value="">
            <div class="allgoods">
                <div class="goodslist" style="width:90%">
                    <label class="col-2">产品名称：</label>
                    <input type="text" class="input-text" value="" name="name" style="width:20%; margin-left: 10px;"><span class="sign">*</span>
                </div>
                <div class="goodslist" style="width:90%;margin-top:3px;">
                    <label class="col-2">产品类别：</label>
                    <select name="cate" style="width:20%;margin-left:10px;">
                        ...
                        <?php foreach($list as $key=>$value): ?>
                            ...
                            <?php endif?>
                        <?php endforeach;?>
                    </select><span class="sign">*</span>
                </div>
                <div class="goodslist" style="width:90%;margin-top:3px;">
                    <label class="col-2">品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>
                    <select name="brand" style="width:20%;margin-left:9px;">
                        <option value="0">选择品牌</option>
                        <?php
                            foreach($brandarr as $key=>$value){
                                if(explode(',',$auth_arr['brand_id_str'])[0])
                                {
                                    if(in_array($value['id'],explode(',',$auth_arr['brand_id_str'])))
                                    {
                                        echo "<option value=$value[id]>$value[brandname]</option>";
                                    }else{
                                        echo "<option disabled style='color: #ccc' value=$value[id]>$value[brandname]</option>";
                                    }
                                }else{
                                    echo "<option value=$value[id]>$value[brandname]</option>";
                                }
                ...
                <div class="goodslist" style="width:90%;margin-top:3px;">
                    ...
                    <input type="text" class="input-text" value="" name="business_men" style="width:20% ;margin-left: 9px;">
                </div>
                <div class="goodslist" style="width:90%;margin-top:3px;">
                    <label class="col-2">发布时间：</label>
                    <input type="text" id="datetimepicker7" class="input-text" value="" name="create_time" style="width:20% ;margin-left: 10px;" >
                </div>
            </div>
			<span style='position:absolute;top:230px;left:30px;'>
			<label>产品型号：</label>
			</span>
            <div class="clearfix cl" id="models">
                ...
                <div class="model" style="width:90%;">
                    ...
                    <div class="modelchild" style="width:90%;">
                        <span style="margin-right: 6px;">关键词：</span><input type="text" value="" name="keywords" style="width:60%;margin-left:12px;">
                    ...
                    <div class="modelchild" style="width:90%;">
                        <span style="font-size: 10px !important;margin-right: 6px;">型号名称：</span><input id="model_number" type="text" value="" name="model_number" style="width: 150px;margin-left:3px;">
                    <span class="sign">*</span>
                    </div>
                    <div class="modelchild xiaoshi" style="width:90%;">
                        <span style="margin-right: 6px;">销售价：</span><input <?php if($auth_arr['publish_goods_sign']=='0'){echo 'disabled';}?> id="price" type="number" value="" name="preferential_price" style="width: 150px">
                        <?php if($auth_arr['publish_goods_sign'] == 1):?>
                        <span class="sign">*</span>
                        <?php endif;?>
                    </div>
                    <div class="modelchild" style="width:90%;">
                        <span style="margin-right: 6px;">市场价：</span><input <?php if($auth_arr['publish_goods_sign']=='0'){echo 'disabled';}?> type="number" value="" name="price" style="width: 150px">
                    </div>
                    <div class="modelchild xiaoshi" style="width:90%;">
                        <span style="margin-right: 6px;">库&nbsp;&nbsp;&nbsp;&nbsp;存：</span><input <?php if($auth_arr['publish_goods_sign']=='0'){echo 'disabled';}?> type="number" value="" name="stock" style="width: 150px;margin-left:7px;">
                        <?php if($auth_arr['publish_goods_sign'] == 1):?>
                            <span class="sign">*</span>
                        <?php endif;?>
                    </div>
                    <div class="modelchild" style="width:90%;">
                        <span style="margin-right: 6px;">销&nbsp;&nbsp;&nbsp;&nbsp;量：</span><input <?php if($auth_arr['publish_goods_sign']=='0'){echo 'disabled';}?> type="number" value="" name="sales_volume" style="width: 150px;margin-left:7px;">
                    </div>
                    <div class="modelchild xiaoshi" style="width:90%;">
                        <span style="margin-right: 6px;">料&nbsp;&nbsp;&nbsp;&nbsp;号：</span><input type="text" value="" name="pn" style="width: 150px;margin-left:7px;">
                    </div>
                    <div class="modelchild" style="width:90%;">
                        <span style="font-size: 10px !important;margin-right: 6px;">到货时间：</span><input <?php if($auth_arr['publish_goods_sign']=='0'){echo 'disabled';}?> type="text" value="" name="model_delivery_time" style="width: 150px;margin-left:1px;">
                        <?php if($auth_arr['publish_goods_sign'] == 1):?>
                            <span class="sign">*</span>
                        <?php endif;?>
                    </div>
                    <div class="modelchild" style="width:90%;">
                    	...
                    	<div id='jiji' style='display:inline-block;margin-left:60px;'>
	                    	<div class='jij' style='margin-left: -3px;'>
		                   		<input type="text" class='key' name="key-0" style="width: 150px">:<input class='val' type="text" name="val-0" style="width: 150px"> <span><a class='del' href='javascript:void(0)'>删除</a></span>  
		                    </div>
                    	</div>
                    </div>
                  <div id='contact_goods' class="clearfix modelchild"><span style="font-size: 10px !important;margin-right: 6px;display:inline-block">关联商品：</span>
                	<div id="odiv_goods" style='margin:-20px 0 0 57px;color:red;'>
	                    <input class='contact_goods_str' type='text' name="associated" />
                    ...
                    <div class="modelchild" style="font-size: 10px !important;width:80%; position: relative">
                       	 售后服务：
                        <select name="after_sales" style="width:150px">
                    ...
                    <div class="modelchild" style="width:1300px;">
                        ...
                        <select id="choose_type" style="width:150px" name='type_id'>
                    ...
                    <div class="modelchild" style="width:245px;margin-left: -20px;">
                        <label class="form-label col-2">是否上架：</label>
                        <div class="formControls col-2 skin-minimal">
                            <div class="check-box" style=" margin-top:5px;margin-left:-10px">
                                <label><input <?php if($auth_arr['publish_goods_sign']=='0'||$auth_arr['publish_goods_sign']==1){echo 'disabled';}?> value='0' name='is_publish' type='radio' class='ace is_publish' /><span class='lbl'>是</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label><input value='1' name='is_publish' checked='checked' type='radio' class='ace is_publish'/><span class='lbl'>否</span></label>
                            </div>
                        </div>
                    </div>
                    <div class="modelchild" style="width:245px;margin-left: -20px;">
                        ...
                        <div class="formControls col-2 skin-minimal">
                            <div class="check-box" style=" margin-top:5px;margin-left:-10px">
                                <label><input value='0' name='is_price_show' checked='checked' type='radio' class='ace is_publish' /><span class='lbl'>是</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label><input value='1' name='is_price_show' type='radio' class='ace is_publish'/><span class='lbl'>否</span></label>
                            </div>
                        </div>
                    </div>
                    <div class='modelchild' style='width:245px;margin-left: -20px;'>
                    ...
                    <div class="modelchild" style="width:80%;float: left" >
                        	图片上传：<a href="javascript:void(0)" class="selectFileBtn" style="margin-left: 10px">图片上传</a>
                    ...
                    <div class="modelchild" style="width:80%;float: left" >
                        ...
                        <div class="formControls col-10">
                            <script id="editor" name="detail_introduce" type="text/plain" style="width:100%;height:400px;"></script>
                        </div>
                    </div>
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-10">
                    <script id="editor1" name="function" type="text/plain" style="width:100%;height:400px;"></script>
                </div>
            </div>
            <div class="clearfix cl">
                <label class="form-label col-2">使用手册：</label>
                <div class="formControls col-10">
                    <script id="editor2" name="manual" type="text/plain" style="width:100%;height:400px;"></script>
                </div>
            </div>
            <div class="clearfix cl">
                ...
                <div class="formControls col-2 skin-minimal">
                    <div class="check-box" style=" margin-top:9px;margin-left:-10px">
                        <label><input name="is_comments" type="radio" class="ace" checked="checked" value="1" /><span class="lbl">是</span></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <label><input name="is_comments" type="radio" class="ace"  value="0" /><span class="lbl">否</span></label>
                    </div>
                </div>
            </div>

            <div class="modelchild" style="width:1200px;margin-left: 20px;">
                <label class="form-label col-2">上传附件：</label>
...
<script>
            ...
            $.post(url,{type_id:type_id,ss:1},function(data){
                ...
                if(parsedJson){
                    ...
                    for(i=0;i<spec_length;i++)
                    {
                        ...
                        html += '<div style="position: relative;width:70%;display:inline-block" ddds='+parsedJson[i]['id']+' class="js-spec-item goods-sku-block-'+parsedJson[i]['id']+'">';
	...
	$('#type').on('click','.js-spec-item span',function(){
        ...
        th_html += '<th class="text-right">预计收货时间</th>';
    	th_html += '</tr>';  
    	...
    	for(var i = 0; i < $sku_array.length; i ++){
    		...
    		html +='<td>';
    		html +='<input <?php if($auth_arr["publish_goods_sign"]=='0'){echo "disabled";}?> type="text" name="sku_price['+child_id_string+']" class="xs js-stock-num" value="'+$temp_Obj[child_id_string]["sku_price"]+'" >';
    		html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">销售价最小为 0.01</span>';
    		html +='</td>';
    		html +='<td>';
    		html +='<input <?php if($auth_arr["publish_goods_sign"]=='0'){echo "disabled";}?> type="text" name="market_price['+child_id_string+']" class="sc js-stock-num" value="'+$temp_Obj[child_id_string]["market_price"]+'">';
    		html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">市场价最小为 0.01</span>';
    		html +='</td>';
    		html +='<td>';
    		html +='<input <?php if($auth_arr["publish_goods_sign"]=='0'){echo "disabled";}?> type="text" name="stock_num['+child_id_string+']" class="kc js-stock-num"  value="'+$temp_Obj[child_id_string]["stock_num"]+'" onkeyup="inputKeyUpNumberValue(this);" onafterpaste="inputAfterPasteNumberValue(this);"/>';
    		html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">库存不能为空</span>';
    		html +='</td>';
    		html +='<td>';
    		html +='<input <?php if($auth_arr["publish_goods_sign"]=='0'){echo "disabled";}?> type="text" name="sales['+child_id_string+']" class="xl js-stock-num"  value="'+$temp_Obj[child_id_string]["sales"]+'" onkeyup="inputKeyUpNumberValue(this);" onafterpaste="inputAfterPasteNumberValue(this);"/>';
    		html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">销量不能为空</span>';
    		html +='</td>';
    		html +='<td>';
    		html +='<input type="text" name="pn['+child_id_string+']" class="lh js-stock-num lhao" value="'+$temp_Obj[child_id_string]["pn"]+'" onkeyup="inputKeyUpNumberValue(this);" onafterpaste="inputAfterPasteNumberValue(this);"/>';
    		html +='<span class="help-inline" style="font-size:11px; color:#b94a48; display:none">料号不能为空</span>';
    		html +='</td>';
            html +='<td>';
            html +='<input <?php if($auth_arr["publish_goods_sign"]=='0'){echo "disabled";}?>  type="text" name="delivery_time['+child_id_string+']" class="js js-stock-num" value="'+$temp_Obj[child_id_string]["delivery_time"]+'" onkeyup="inputKeyUpNumberValue(this);" onafterpaste="inputAfterPasteNumberValue(this);"/>';
    ...
    $(function() {
        ...
        $("#models").on('click','.selectFileBtn',function(){
            ...
            $fileField = $("<input class='proImg' type='file' name='proImg["+model_id+"][]'/>");
            $fileField.hide();
