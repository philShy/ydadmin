            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <?php foreach($article as $key=>$value):?>
                    <tr>
                        ...
                        <td style="text-align: left"><?php $aa = CImages::searchArticle_Byid($value['id']);
                        if($aa)
                        {
                        	foreach($aa as $k=>$v)
                        	{
                        ...
                        <td>
                            ...
                            <a title="编辑" href="/images/editarticle_images?article_id=<?php echo $value['id']?>&title=<?php echo $value['title']?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                        </td>
                    </tr>
                <?php endforeach;?>
                </tbody>
