            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <?php foreach($brand as $key=>$value):?>
                    <tr>
						...
						<image src="<?php echo $value['img_url']?>" style="width:60px;height:60px;margin-left:15px;">
                       </td>
                        ...
                        <td>
                            ...
                            <a title="编辑" href="/images/editbrand?brand_id=<?php echo $value['id']?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                        </td>
                    </tr>
                <?php endforeach;?>
                </tbody>
