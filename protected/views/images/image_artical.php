                    ...
                    <tr>
                        ...
                        <td><?php echo $value['title']?></td>
                         <td style="text-align: left"><?php 
                                        ...
                                        echo "<image src='$value[article_img]'style='width:60px;height:60px;margin-left:15px;'>";;
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑"  href="../images/editartical_images?id=<?php echo $value['id']?>"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120">编辑</i></a>
