            ...
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <?php foreach($product as $key=>$value):?>
                    <tr>
                        ...
                        <td style="text-align: left"><?php $aa = CImages::searchmodel_Imagecate($value['id']);
                                    foreach($aa as $k=>$v)
                                    {
                                        echo "<image src='$v[image_url]'style='width:60px;height:60px;margin-left:15px;'>";;
                                    }
                            ?></td>
                        <td style="display: none"></td>
                        <td style="display: none"></td>
                        ...
                        <td>
                            ...
                            <a title="编辑" href="/images/editproduct_images?model_id=<?php echo $value['id']?>&model_number=<?php echo $value['model_number']?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>
                        </td>
                    </tr>
                <?php endforeach;?>
                </tbody>
